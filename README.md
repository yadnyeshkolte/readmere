...
This project demonstrates the power of **multi-agent MCP systems** through Archestra — specialized agents communicating via the standardized Model Context Protocol produce better results than monolithic prompts. The analyzer doesn't waste LLM tokens on file listing, the scorer can't be biased by the generator's instructions, and each agent evolves independently.
...
<p align="center">
  ...
  <br/>
  Built with ❤️ by <a href="https://github.com/yadnyeshkolte">Yadnyesh Kolte</a> for the 2 Fast 2 MCP Hackathon
</p>
